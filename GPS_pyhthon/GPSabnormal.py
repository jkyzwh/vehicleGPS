...
def funAbnormalData(GPSData,probs = 0.95):
    ...
    for i in range(len(GPSData.index)):
        if GPSData.Acc.iloc[i] > 0 and GPSData.Acc.iloc[i] > GPSData.ay_abnormalAAC.iloc[i]:
            GPSData.abnormal.values[i] = "ay_AAC"
        if GPSData.Acc.iloc[i] < 0 and GPSData.Acc.iloc[i] < GPSData.ay_abnormalDAC.iloc[i]:
            GPSData.abnormal.values[i] = "ay_DAC"
    GPSData_ab = GPSData.loc[GPSData['abnormal'] != "normal"].copy()
...
GPSData = GPSData_initial.loc[GPSData_initial['vehicleID'] == IDTest].copy()
...
GPSData['speed_split'] = round(GPSData.GPS_Speed/10)        #按照速度值分组
...
for i in range(len(ID.index)):
    IDn = ID.iloc[i]
    GPSData = vehicleDataINI(GPSData_initial,ID)
...
#==============================================================================
col= [
"white"	,	"aliceblue"	,"antiquewhite"	,	"antiquewhite1"	,"antiquewhite2"	,	"antiquewhite3"	,
...
"burlywood4"	,	"cadetblue"	,"cadetblue1"	,	"cadetblue2"	,"cadetblue3"	,	"cadetblue4"	,"chartreuse"	,	"chartreuse1"	,
"chartreuse2"	,	"chartreuse3"	,"chartreuse4"	,	"chocolate"	,"chocolate1"	,	"chocolate2"	,"chocolate3"	,	"chocolate4"	,
"coral"	,	"coral1"	,"coral2"	,	"coral3"	,"coral4"	,	"cornflowerblue"	,"cornsilk"	,	"cornsilk1"	,"cornsilk2"	,	"cornsilk3"	,
"cornsilk4"	,	"cyan"	,"cyan1"	,	"cyan2"	,"cyan3"	,	"cyan4"	,"darkblue"	,	"darkcyan"	,"darkgoldenrod"	,	"darkgoldenrod1"	,
"darkgoldenrod2"	,	"darkgoldenrod3"	,"darkgoldenrod4"	,	"darkgray"	,"darkgreen"	,	"darkgrey"	,"darkkhaki"	,	"darkmagenta"	,
"darkolivegreen"	,	"darkolivegreen1"	,"darkolivegreen2"	,	"darkolivegreen3"	,"darkolivegreen4"	,	"darkorange"	,
"darkorange1"	,	"darkorange2"	,"darkorange3"	,	"darkorange4"	,"darkorchid"	,	"darkorchid1"	,"darkorchid2"	,	"darkorchid3"	,
"darkorchid4"	,	"darkred"	,"darksalmon"	,	"darkseagreen"	,"darkseagreen1"	,	"darkseagreen2"	,"darkseagreen3"	,	"darkseagreen4"	,
"darkslateblue"	,	"darkslategray"	,"darkslategray1"	,	"darkslategray2"	,"darkslategray3"	,	"darkslategray4"	,"darkslategrey"	,
"darkturquoise"	,"darkviolet"	,	"deeppink"	,"deeppink1"	,	"deeppink2"	,"deeppink3"	,	"deeppink4"	,"deepskyblue"	,	"deepskyblue1"	,
"deepskyblue2"	,	"deepskyblue3"	,"deepskyblue4"	,	"dimgray"	,"dimgrey"	,	"dodgerblue"	,"dodgerblue1"	,	"dodgerblue2"	,
"dodgerblue3"	,	"dodgerblue4"	,"firebrick"	,	"firebrick1"	,"firebrick2"	,	"firebrick3"	,"firebrick4"	,	"floralwhite"	,
